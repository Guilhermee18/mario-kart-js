...
<ul>
  ...
  <li><input type="checkbox" id="pistas-2-item" checked /> <label for="pistas-2-item">A cada rodada, será sorteado um bloco da pista que pode ser uma reta, curva ou confronto</label>
    <ul>
      ...
      <li><input type="checkbox" id="pistas-2-4-item" checked /> <label for="pistas-2-4-item">Nenhum jogador pode ter pontuação negativa (valores abaixo de 0)</label></li>
    </ul>
  </li>
</ul>
...
<p>Além das mecânicas básicas do desafio, foram adicionadas as seguintes regras extras no código:</p>

<ul>
  <li>🌧️ <b>Eventos Climáticos:</b> Eventos aleatórios a cada rodada, como Chuva (reduz a velocidade dos jogadores) e Pista em Chamas (dobra o dano do confronto).</li>
  <li>🚀 <b>Mecânica de Turbo:</b> Chance de obter um turbo e somar +1 ponto extra ao vencer confrontos.</li>
  <li>📊 <b>Painel de Estatísticas:</b> Relatório completo exibido ao final da partida com a contagem de vitórias em pistas, turbos utilizados e confrontos vencidos.</li>
</ul>